...
public class NProducto extends javax.swing.JDialog {
    ...
    private void JtGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JtGuardarActionPerformed
     ...
     JOptionPane.showMessageDialog(this, "Producto Guardado Correctamente!!!","TOP-SUELAS" ,JOptionPane.INFORMATION_MESSAGE);
     informacion = "1";
     Limpiar();   
     }else{
    ...
    private javax.swing.JTextArea JaObservacion;
    ...
    private javax.swing.JComboBox<String> JcCorrida;
