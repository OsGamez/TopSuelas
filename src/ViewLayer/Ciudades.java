...
public class Ciudades extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel modelCiudad = new DefaultTableModel() {
        @Override
    ...
    public Ciudades() {
        ...
        LoadColumns();
        LoadModelCiudad();
        JtDatosCiudad.getTableHeader().setReorderingAllowed(false);
    }
    ...
    private void initComponents() {
        ...
        JtDatosCiudad = new javax.swing.JTable();

        setClosable(true);
        setMaximizable(true);
        setTitle("CIUDADES");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Citycons_building_icon-icons.com_67935.png"))); // NOI18N
    ...
    private void JbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbNuevoActionPerformed
        NCiudad nuevo = new NCiudad(null, true);
    ...
    private void JbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbEliminarActionPerformed
        int row = JtDatosCiudad.getSelectedRow();
        ...
        try {
            if (row >= 0) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    int id = Integer.parseInt(JtDatosCiudad.getValueAt(row, 0).toString());
                    String desc = JtDatosCiudad.getValueAt(row, 1).toString();
                    if (obj.ciudadDelete(id, desc)) {
                        modelCiudad.removeRow(row);
                        JOptionPane.showMessageDialog(null, "Registro eliminado");
                    } else {
                        JOptionPane.showMessageDialog(null, "Esta ciudad se encuentra asociado con un cliente");
                    }
                }
            } else {
    ...
    private void JbEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbEditarActionPerformed
        NCiudad editar = new NCiudad(null, true);
        int fila = JtDatosCiudad.getSelectedRow();
        ...
        try {
            if (fila >= 0) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    editar.Jtid.setText(JtDatosCiudad.getValueAt(fila, 1).toString());
                    editar.JtDescripcion.setText(JtDatosCiudad.getValueAt(fila, 1).toString());
    ...
    private void LoadColumns() {
        modelCiudad.addColumn("Código");
        modelCiudad.addColumn("DESCRIPCIÓN");
        JtDatosCiudad.getColumnModel().getColumn(0).setMaxWidth(0);
        JtDatosCiudad.getColumnModel().getColumn(0).setMinWidth(0);
        JtDatosCiudad.getColumnModel().getColumn(0).setPreferredWidth(0);
    }

    private void LoadModelCiudad() {

        ArrayList<Ciudad> listaCiudades = obj.ciudadesGetAll();

        modelCiudad.setNumRows(listaCiudades.size());
        ...
        for (int i = 0; i < listaCiudades.size(); i++) {
            ...
            modelCiudad.setValueAt(id, i, 0);
            modelCiudad.setValueAt(descripcion, i, 1);
        }
    }
    ...
    private void JbReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbReporteActionPerformed
        try {
            ...
            reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reports/CatalogoCiudades.jasper"));
            try {
    ...
    private void CleanTable() {
        int numFilas = modelCiudad.getRowCount();
        if (numFilas > 0) {
            for (int i = numFilas - 1; i >= 0; i--) {
                modelCiudad.removeRow(i);
            }
        }
    }
    ...
    private javax.swing.JTable JtDatosCiudad;
