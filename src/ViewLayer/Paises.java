...
public class Paises extends javax.swing.JInternalFrame {
    ...
    public Paises() {
        ...
        LoadColumns();
        LoadModelPais();
        JtDatosPais.getTableHeader().setReorderingAllowed(false);
    }
    ...
    private void initComponents() {
        ...
        JtDatosPais = new javax.swing.JTable();

        setClosable(true);
        setMaximizable(true);
        setTitle("PAISES");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/mexico_flags_flag_17036.png"))); // NOI18N
        ...
        JtDatosPais.setModel(modelPais
        );
        jScrollPane1.setViewportView(JtDatosPais);
    ...
    private void JbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbNuevoActionPerformed
        NPais nuevo = new NPais(null, true);
    ...
    private javax.swing.JTable JtDatosPais;
