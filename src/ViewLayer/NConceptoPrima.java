...
public class NConceptoPrima extends javax.swing.JDialog {

    ObjectConceptosPrima obj = new ObjectConceptosPrima();
    String informacion = "";

    public NConceptoPrima(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void JbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbGuardarActionPerformed
        ...
        if (JtCuenta.getText().isEmpty() || JtSubCuenta.getText().isEmpty()) {
            ...
            if (v.verificanumeros(JtCuenta.getText()) && v.verificanumeros(JtSubCuenta.getText()) 
                    && obj.validarCuenta(JtCuenta.getText(), JtSubCuenta.getText())) {
                Guardar();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NConceptoPrima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NConceptoPrima dialog = new NConceptoPrima(new javax.swing.JFrame(), true);
