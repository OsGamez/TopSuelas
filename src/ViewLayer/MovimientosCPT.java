...
public class MovimientosCPT extends javax.swing.JInternalFrame {
    ...
    ObjectKardex obj = new ObjectKardex();
    ...
    private void initComponents() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/exchange.png"))); // NOI18N
    ...
    private void JbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbNuevoActionPerformed
        MovimientosesCPT nuevo = new MovimientosesCPT();
...
//        }
    ...
    private void LoadColumns() {
        ...
        model.addColumn("SUELA");
        model.addColumn("CANTIDAD");
    }

    private void LoadModel() {

        ArrayList<Kardex> listK = obj.getKardex();

        model.setNumRows(listK.size());

        for (int i = 0; i < listK.size(); i++) {
            Kardex k = listK.get(i);

            model.setValueAt(k.getFolio(), i, 0);
            model.setValueAt(k.getCuenta(), i, 1);
            model.setValueAt(k.getSubCuenta(), i, 2);
            model.setValueAt(k.getFMovimiento(), i, 3);
            model.setValueAt(k.getSerie(), i, 4);
            model.setValueAt(k.getDam(), i, 5);
            model.setValueAt(k.getDsuela(), i, 6);
            model.setValueAt(k.getTotalPares(), i, 7);
        }
    }
    ...
    private void JtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JtBuscarKeyReleased
        CleanTable();
        ArrayList<Kardex> listK = obj.getKardexByFolio(JtBuscar.getText());
    ...
    private void JbReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbReporteActionPerformed
        try {
            ...
            try {
                ...
                Logger.getLogger(MovimientosCPT.class.getName()).log(Level.SEVERE, null, ex);
