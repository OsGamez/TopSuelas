...
public class Bancos extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel modelBanco = new DefaultTableModel() {
        @Override
    ...
    public Bancos() {
        ...
        LoadColumns();
        LoadModelBanco();
        JtDatosBanco.getTableHeader().setReorderingAllowed(false);
    }
    ...
    private void initComponents() {
        ...
        JtDatosBanco = new javax.swing.JTable();

        setClosable(true);
        setMaximizable(true);
        setTitle("BANCO");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/bank_78392.png"))); // NOI18N
    ...
    private void JbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbNuevoActionPerformed
        NBanco nuevo = new NBanco(null, true);
    ...
    private void JbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbEliminarActionPerformed
        int row = JtDatosBanco.getSelectedRow();
            ...
            if (row >= 0) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    if (obj.bancoDelete(id, des)) {
                        ...
                        JOptionPane.showMessageDialog(null, "Este banco se encuentra asociado con un cliente");
                    }
                }
            } else {
    ...
    private void LoadColumns() {
        modelBanco.addColumn("Código");
        modelBanco.addColumn("DESCRIPCIÓN");
        modelBanco.addColumn("RFC");
        modelBanco.addColumn("CTA");
        JtDatosBanco.getColumnModel().getColumn(0).setMaxWidth(0);
        JtDatosBanco.getColumnModel().getColumn(0).setMinWidth(0);
        JtDatosBanco.getColumnModel().getColumn(0).setPreferredWidth(0);

    }

    private void LoadModelBanco() {

        ArrayList<Banco> listaBancos = obj.bancosGetAll();

        modelBanco.setNumRows(listaBancos.size());
    ...
    private void JtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JtBuscarKeyReleased
        CleanTable();
        JtBuscar.getText();
        ArrayList<Banco> listaBancos = obj.bancoSearch(JtBuscar.getText());
    ...
    private void JbReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbReporteActionPerformed
        try {
            ...
            reporte = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/Reports/CatalogoBancos.jasper"));
            try {
    ...
    private void CleanTable() {
        int numFilas = modelBanco.getRowCount();
        if (numFilas > 0) {
            for (int i = numFilas - 1; i >= 0; i--) {
                modelBanco.removeRow(i);
            }
        }
    }
    ...
    private javax.swing.JTable JtDatosBanco;
