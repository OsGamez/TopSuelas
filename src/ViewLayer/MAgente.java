...
public class MAgente extends javax.swing.JDialog {

    ObjectAgentes obj = new ObjectAgentes();
    String informacion = "";

    public MAgente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MAgente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MAgente dialog = new MAgente(new javax.swing.JFrame(), true);
