...
public class MLinea extends javax.swing.JDialog {

    ObjectLineas obj = new ObjectLineas();
    String informacion = "";
    public MLinea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void JbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbGuardarActionPerformed
           if(JtDescripcion.getText().isEmpty()){
                ...
                linea.setId_Linea(Integer.parseInt(JtId.getText()));
                linea.setDescripcion(JtDescripcion.getText());
                linea.setActivo(true);
                if(obj.lineaUpdate(linea)){
                 JOptionPane.showMessageDialog(this, "Linea Modificada Correctamente!!!","TOP-SUELAS" ,JOptionPane.INFORMATION_MESSAGE);
                 dispose();
                 informacion = "1";   
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MLinea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MLinea dialog = new MLinea(new javax.swing.JFrame(), true);
