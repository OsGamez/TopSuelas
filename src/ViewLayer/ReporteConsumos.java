...
public class ReporteConsumos extends javax.swing.JDialog {

    Connection c = Server.getProduccion();
    Vector<Linea> datos = new Vector<Linea>();

    public ReporteConsumos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void JbImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbImprimirActionPerformed
        ...
        if (Jts.isSelected() == false && Jtt.isSelected() == false) {
            ...
            try {
                ...
                JasperReport reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reports/CatalogoConsumos.jasper"));
                try {
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteConsumos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteConsumos dialog = new ReporteConsumos(new javax.swing.JFrame(), true);
