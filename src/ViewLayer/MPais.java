...
public class MPais extends javax.swing.JDialog {

    ObjectPaises obj = new ObjectPaises();
    String informacion = "";
    public MPais(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     if(JtDescripcion.getText().isEmpty()){
           JOptionPane.showMessageDialog(this, "Ingresa una descripción","TOP-SUELAS" ,JOptionPane.WARNING_MESSAGE);
            ...
            if(obj.paisUpdate(pais)){
             ...
             JOptionPane.showMessageDialog(null,"El pais ya existe","TOP-SUELAS" ,JOptionPane.WARNING_MESSAGE); 
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MPais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MPais dialog = new MPais(new javax.swing.JFrame(), true);
